...
#define atomicSub(var,valC) __sync_fetch_and_sub((volatile unsigned int*)var,valC)
...
#define myassert( X , MSG) if ( !(X) ) { printf( "%s, Thread %u failed assert at %s:%d!\n", MSG, (unsigned)TID, __FILE__,__LINE__ ); __exit(); return NULL; }

...
// #############################################################################
  ...
  // print info to the log
    ...
    #include "DefineSamples_Data.cxx"
    #include "DefineSamples_Simulation.cxx"
...
*/
		...
		// ================= OS Distributions =========================
                ...
                // Nj>=2 Nb0>=0 Counters --------------------------------------
                histo[i][1830] = new TH1D(c(n, i, "_ZlljetsDD_NjGe2NbGe0_OS"),      c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR NjGe2NbGe0 OS"),  10, -0.5,  9.5  );
                histo[i][1831] = new TH1D(c(n, i, "_ZlljetsDD_NjGe2Nb0_OS"),        c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR NjGe2Nb0 OS"),    10, -0.5,  9.5  );
                histo[i][1832] = new TH1D(c(n, i, "_ZlljetsDD_NjGe2Nb1_OS"),        c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR NjGe2Nb1 OS"),    10, -0.5,  9.5  );
                histo[i][1833] = new TH1D(c(n, i, "_ZlljetsDD_NjGe2Nb2_OS"),        c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR NjGe2Nb2 OS"),    10, -0.5,  9.5  );
                // Nj=2 Counters 
                histo[i][1834] = new TH1D(c(n, i, "_ZlljetsDD_Nj2Pre_OS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj2Pre OS"),     10, -0.5,  9.5  );
                histo[i][1835] = new TH1D(c(n, i, "_ZlljetsDD_Nj2Nb0_OS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj2Nb0 OS"),     10, -0.5,  9.5  );
                histo[i][1836] = new TH1D(c(n, i, "_ZlljetsDD_Nj2Nb1_OS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj2Nb1 OS"),     10, -0.5,  9.5  );
                histo[i][1837] = new TH1D(c(n, i, "_ZlljetsDD_Nj2Nb2_OS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj2Nb2 OS"),     10, -0.5,  9.5  );
                // Nj=3 Counters
                histo[i][1838] = new TH1D(c(n, i, "_ZlljetsDD_Nj3Pre_OS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj3Pre OS"),     10, -0.5,  9.5  );
                histo[i][1839] = new TH1D(c(n, i, "_ZlljetsDD_Nj3Nb0_OS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj3Nb0 OS"),     10, -0.5,  9.5  );
                histo[i][1840] = new TH1D(c(n, i, "_ZlljetsDD_Nj3Nb1_OS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj3Nb1 OS"),     10, -0.5,  9.5  );
                histo[i][1841] = new TH1D(c(n, i, "_ZlljetsDD_Nj3Nb2_OS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj3Nb2 OS"),     10, -0.5,  9.5  );
                // Nj=4 Counters
                histo[i][1842] = new TH1D(c(n, i, "_ZlljetsDD_Nj4Pre_OS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj4Pre OS"),     10, -0.5,  9.5  );
                histo[i][1843] = new TH1D(c(n, i, "_ZlljetsDD_Nj4Nb0_OS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj4Nb0 OS"),     10, -0.5,  9.5  );
                histo[i][1844] = new TH1D(c(n, i, "_ZlljetsDD_Nj4Nb1_OS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj4Nb1 OS"),     10, -0.5,  9.5  );
                histo[i][1845] = new TH1D(c(n, i, "_ZlljetsDD_Nj4Nb2_OS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj4Nb2 OS"),     10, -0.5,  9.5  );
                // Nj=5 Counters
                histo[i][1846] = new TH1D(c(n, i, "_ZlljetsDD_Nj5Pre_OS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj5Pre OS"),     10, -0.5,  9.5  );
                histo[i][1847] = new TH1D(c(n, i, "_ZlljetsDD_Nj5Nb0_OS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj5Nb0 OS"),     10, -0.5,  9.5  );
                histo[i][1848] = new TH1D(c(n, i, "_ZlljetsDD_Nj5Nb1_OS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj5Nb1 OS"),     10, -0.5,  9.5  );
                histo[i][1849] = new TH1D(c(n, i, "_ZlljetsDD_Nj5Nb2_OS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj5Nb2 OS"),     10, -0.5,  9.5  );
                // Nj>=6 Counters
                histo[i][1850] = new TH1D(c(n, i, "_ZlljetsDD_Nj6Pre_OS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj6Pre OS"),     10, -0.5,  9.5  );
                histo[i][1851] = new TH1D(c(n, i, "_ZlljetsDD_Nj6Nb0_OS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj6Nb0 OS"),     10, -0.5,  9.5  );
                histo[i][1852] = new TH1D(c(n, i, "_ZlljetsDD_Nj6Nb1_OS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj6Nb1 OS"),     10, -0.5,  9.5  );
                histo[i][1853] = new TH1D(c(n, i, "_ZlljetsDD_Nj6Nb2_OS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj6Nb2 OS"),     10, -0.5,  9.5  );

                // Nj>=2 Nb0>=0 Mass(ll) --------------------------------------
                histo[i][1860] = new TH1D(c(n, i, "_ZMll_NjGe2NbGe0_OS"),          c(t, i, ": ZMll Nj2GeNbGe0 OS"),                      bM,    lM, hM    );
                histo[i][1861] = new TH1D(c(n, i, "_ZMll_NjGe2Nb0_OS"),            c(t, i, ": ZMll Nj2GeNb0 OS"),                        bM,    lM, hM    );
                histo[i][1862] = new TH1D(c(n, i, "_ZMll_NjGe2Nb1_OS"),            c(t, i, ": ZMll Nj2GeNb1 OS"),                        bM,    lM, hM    );
                histo[i][1863] = new TH1D(c(n, i, "_ZMll_NjGe2Nb2_OS"),            c(t, i, ": ZMll Nj2GeNb2 OS"),                        bM,    lM, hM    );
                // Nj=2 
                histo[i][1864] = new TH1D(c(n, i, "_ZMll_Nj2Pre_OS"),              c(t, i, ": ZMll Nj2Pre OS"),                          bM,    lM, hM    );
                histo[i][1865] = new TH1D(c(n, i, "_ZMll_Nj2Nb0_OS"),              c(t, i, ": ZMll Nj2Nb0 OS"),                          bM,    lM, hM    );
                histo[i][1866] = new TH1D(c(n, i, "_ZMll_Nj2Nb1_OS"),              c(t, i, ": ZMll Nj2Nb1 OS"),                          bM,    lM, hM    );
                histo[i][1867] = new TH1D(c(n, i, "_ZMll_Nj2Nb2_OS"),              c(t, i, ": ZMll Nj2Nb2 OS"),                          bM,    lM, hM    );
                // Nj=3
                histo[i][1868] = new TH1D(c(n, i, "_ZMll_Nj3Pre_OS"),              c(t, i, ": ZMll Nj3Pre OS"),                          bM,    lM, hM    );
                histo[i][1869] = new TH1D(c(n, i, "_ZMll_Nj3Nb0_OS"),              c(t, i, ": ZMll Nj3Nb0 OS"),                          bM,    lM, hM    );
                histo[i][1870] = new TH1D(c(n, i, "_ZMll_Nj3Nb1_OS"),              c(t, i, ": ZMll Nj3Nb1 OS"),                          bM,    lM, hM    );
                histo[i][1871] = new TH1D(c(n, i, "_ZMll_Nj3Nb2_OS"),              c(t, i, ": ZMll Nj3Nb2 OS"),                          bM,    lM, hM    );
                // Nj=4
                histo[i][1872] = new TH1D(c(n, i, "_ZMll_Nj4Pre_OS"),              c(t, i, ": ZMll Nj4Pre OS"),                          bM,    lM, hM    );
                histo[i][1873] = new TH1D(c(n, i, "_ZMll_Nj4Nb0_OS"),              c(t, i, ": ZMll Nj4Nb0 OS"),                          bM,    lM, hM    );
                histo[i][1874] = new TH1D(c(n, i, "_ZMll_Nj4Nb1_OS"),              c(t, i, ": ZMll Nj4Nb1 OS"),                          bM,    lM, hM    );
                histo[i][1875] = new TH1D(c(n, i, "_ZMll_Nj4Nb2_OS"),              c(t, i, ": ZMll Nj4Nb2 OS"),                          bM,    lM, hM    );
                // Nj=5
                histo[i][1876] = new TH1D(c(n, i, "_ZMll_Nj5Pre_OS"),              c(t, i, ": ZMll Nj5Pre OS"),                          bM,    lM, hM    );
                histo[i][1877] = new TH1D(c(n, i, "_ZMll_Nj5Nb0_OS"),              c(t, i, ": ZMll Nj5Nb0 OS"),                          bM,    lM, hM    );
                histo[i][1878] = new TH1D(c(n, i, "_ZMll_Nj5Nb1_OS"),              c(t, i, ": ZMll Nj5Nb1 OS"),                          bM,    lM, hM    );
                histo[i][1879] = new TH1D(c(n, i, "_ZMll_Nj5Nb2_OS"),              c(t, i, ": ZMll Nj5Nb2 OS"),                          bM,    lM, hM    );
                // Nj>=6
                histo[i][1880] = new TH1D(c(n, i, "_ZMll_Nj6Pre_OS"),              c(t, i, ": ZMll Nj6Pre OS"),                          bM,    lM, hM    );
                histo[i][1881] = new TH1D(c(n, i, "_ZMll_Nj6Nb0_OS"),              c(t, i, ": ZMll Nj6Nb0 OS"),                          bM,    lM, hM    );
                histo[i][1882] = new TH1D(c(n, i, "_ZMll_Nj6Nb1_OS"),              c(t, i, ": ZMll Nj6Nb1 OS"),                          bM,    lM, hM    );
                histo[i][1883] = new TH1D(c(n, i, "_ZMll_Nj6Nb2_OS"),              c(t, i, ": ZMll Nj6Nb2 OS"),                          bM,    lM, hM    );

                // Nj>=2 Nb0>=0 Pt (ttbar) ------------------------------------
                histo[i][1890] = new TH1D(c(n, i, "_PTZll_NjGe2NbGe0_OS"),          c(t, i, ": PTZll Nj2GeNbGe0 OS"),                      bPt,    lPt, hPt    );
                histo[i][1891] = new TH1D(c(n, i, "_PTZll_NjGe2Nb0_OS"),            c(t, i, ": PTZll Nj2GeNb0 OS"),                        bPt,    lPt, hPt    );
                histo[i][1892] = new TH1D(c(n, i, "_PTZll_NjGe2Nb1_OS"),            c(t, i, ": PTZll Nj2GeNb1 OS"),                        bPt,    lPt, hPt    );
                histo[i][1893] = new TH1D(c(n, i, "_PTZll_NjGe2Nb2_OS"),            c(t, i, ": PTZll Nj2GeNb2 OS"),                        bPt,    lPt, hPt    );
                // Nj=2 
                histo[i][1894] = new TH1D(c(n, i, "_PTZll_Nj2Pre_OS"),              c(t, i, ": PTZll Nj2Pre OS"),                          bPt,    lPt, hPt    );
                histo[i][1895] = new TH1D(c(n, i, "_PTZll_Nj2Nb0_OS"),              c(t, i, ": PTZll Nj2Nb0 OS"),                          bPt,    lPt, hPt    );
                histo[i][1896] = new TH1D(c(n, i, "_PTZll_Nj2Nb1_OS"),              c(t, i, ": PTZll Nj2Nb1 OS"),                          bPt,    lPt, hPt    );
                histo[i][1897] = new TH1D(c(n, i, "_PTZll_Nj2Nb2_OS"),              c(t, i, ": PTZll Nj2Nb2 OS"),                          bPt,    lPt, hPt    );
                // Nj=3
                histo[i][1898] = new TH1D(c(n, i, "_PTZll_Nj3Pre_OS"),              c(t, i, ": PTZll Nj3Pre OS"),                          bPt,    lPt, hPt    );
                histo[i][1899] = new TH1D(c(n, i, "_PTZll_Nj3Nb0_OS"),              c(t, i, ": PTZll Nj3Nb0 OS"),                          bPt,    lPt, hPt    );
                histo[i][1900] = new TH1D(c(n, i, "_PTZll_Nj3Nb1_OS"),              c(t, i, ": PTZll Nj3Nb1 OS"),                          bPt,    lPt, hPt    );
                histo[i][1901] = new TH1D(c(n, i, "_PTZll_Nj3Nb2_OS"),              c(t, i, ": PTZll Nj3Nb2 OS"),                          bPt,    lPt, hPt    );
                // Nj=4
                histo[i][1902] = new TH1D(c(n, i, "_PTZll_Nj4Pre_OS"),              c(t, i, ": PTZll Nj4Pre OS"),                          bPt,    lPt, hPt    );
                histo[i][1903] = new TH1D(c(n, i, "_PTZll_Nj4Nb0_OS"),              c(t, i, ": PTZll Nj4Nb0 OS"),                          bPt,    lPt, hPt    );
                histo[i][1904] = new TH1D(c(n, i, "_PTZll_Nj4Nb1_OS"),              c(t, i, ": PTZll Nj4Nb1 OS"),                          bPt,    lPt, hPt    );
                histo[i][1905] = new TH1D(c(n, i, "_PTZll_Nj4Nb2_OS"),              c(t, i, ": PTZll Nj4Nb2 OS"),                          bPt,    lPt, hPt    );
                // Nj=5
                histo[i][1906] = new TH1D(c(n, i, "_PTZll_Nj5Pre_OS"),              c(t, i, ": PTZll Nj5Pre OS"),                          bPt,    lPt, hPt    );
                histo[i][1907] = new TH1D(c(n, i, "_PTZll_Nj5Nb0_OS"),              c(t, i, ": PTZll Nj5Nb0 OS"),                          bPt,    lPt, hPt    );
                histo[i][1908] = new TH1D(c(n, i, "_PTZll_Nj5Nb1_OS"),              c(t, i, ": PTZll Nj5Nb1 OS"),                          bPt,    lPt, hPt    );
                histo[i][1909] = new TH1D(c(n, i, "_PTZll_Nj5Nb2_OS"),              c(t, i, ": PTZll Nj5Nb2 OS"),                          bPt,    lPt, hPt    );
                // Nj>=6
                histo[i][1910] = new TH1D(c(n, i, "_PTZll_Nj6Pre_OS"),              c(t, i, ": PTZll Nj6Pre OS"),                          bPt,    lPt, hPt    );
                histo[i][1911] = new TH1D(c(n, i, "_PTZll_Nj6Nb0_OS"),              c(t, i, ": PTZll Nj6Nb0 OS"),                          bPt,    lPt, hPt    );
                histo[i][1912] = new TH1D(c(n, i, "_PTZll_Nj6Nb1_OS"),              c(t, i, ": PTZll Nj6Nb1 OS"),                          bPt,    lPt, hPt    );
                histo[i][1913] = new TH1D(c(n, i, "_PTZll_Nj6Nb2_OS"),              c(t, i, ": PTZll Nj6Nb2 OS"),                          bPt,    lPt, hPt    );
                ...
                // Nj>=2 Nb0>=0 ETA (l+l-) ------------------------------------
                histo[i][1950] = new TH1D(c(n, i, "_ZEtall_NjGe2NbGe0_OS"),          c(t, i, ": ZEtall Nj2GeNbGe0 OS"),                     40, -4.0, 4.0);
                histo[i][1951] = new TH1D(c(n, i, "_ZEtall_NjGe2Nb0_OS"),            c(t, i, ": ZEtall Nj2GeNb0 OS"),                       40, -4.0, 4.0);
                histo[i][1952] = new TH1D(c(n, i, "_ZEtall_NjGe2Nb1_OS"),            c(t, i, ": ZEtall Nj2GeNb1 OS"),                       40, -4.0, 4.0);
                histo[i][1953] = new TH1D(c(n, i, "_ZEtall_NjGe2Nb2_OS"),            c(t, i, ": ZEtall Nj2GeNb2 OS"),                       40, -4.0, 4.0);
                // Nj=2 
                histo[i][1954] = new TH1D(c(n, i, "_ZEtall_Nj2Pre_OS"),              c(t, i, ": ZEtall Nj2Pre OS"),                          40, -4.0, 4.0);
                histo[i][1955] = new TH1D(c(n, i, "_ZEtall_Nj2Nb0_OS"),              c(t, i, ": ZEtall Nj2Nb0 OS"),                          40, -4.0, 4.0);
                histo[i][1956] = new TH1D(c(n, i, "_ZEtall_Nj2Nb1_OS"),              c(t, i, ": ZEtall Nj2Nb1 OS"),                          40, -4.0, 4.0);
                histo[i][1957] = new TH1D(c(n, i, "_ZEtall_Nj2Nb2_OS"),              c(t, i, ": ZEtall Nj2Nb2 OS"),                          40, -4.0, 4.0);
                // Nj=3
                histo[i][1958] = new TH1D(c(n, i, "_ZEtall_Nj3Pre_OS"),              c(t, i, ": ZEtall Nj3Pre OS"),                          40, -4.0, 4.0);
                histo[i][1959] = new TH1D(c(n, i, "_ZEtall_Nj3Nb0_OS"),              c(t, i, ": ZEtall Nj3Nb0 OS"),                          40, -4.0, 4.0);
                histo[i][1960] = new TH1D(c(n, i, "_ZEtall_Nj3Nb1_OS"),              c(t, i, ": ZEtall Nj3Nb1 OS"),                          40, -4.0, 4.0);
                histo[i][1961] = new TH1D(c(n, i, "_ZEtall_Nj3Nb2_OS"),              c(t, i, ": ZEtall Nj3Nb2 OS"),                          40, -4.0, 4.0);
                // Nj=4
                histo[i][1962] = new TH1D(c(n, i, "_ZEtall_Nj4Pre_OS"),              c(t, i, ": ZEtall Nj4Pre OS"),                          40, -4.0, 4.0);
                histo[i][1963] = new TH1D(c(n, i, "_ZEtall_Nj4Nb0_OS"),              c(t, i, ": ZEtall Nj4Nb0 OS"),                          40, -4.0, 4.0);
                histo[i][1964] = new TH1D(c(n, i, "_ZEtall_Nj4Nb1_OS"),              c(t, i, ": ZEtall Nj4Nb1 OS"),                          40, -4.0, 4.0);
                histo[i][1965] = new TH1D(c(n, i, "_ZEtall_Nj4Nb2_OS"),              c(t, i, ": ZEtall Nj4Nb2 OS"),                          40, -4.0, 4.0);
                // Nj=5
                histo[i][1966] = new TH1D(c(n, i, "_ZEtall_Nj5Pre_OS"),              c(t, i, ": ZEtall Nj5Pre OS"),                          40, -4.0, 4.0);
                histo[i][1967] = new TH1D(c(n, i, "_ZEtall_Nj5Nb0_OS"),              c(t, i, ": ZEtall Nj5Nb0 OS"),                          40, -4.0, 4.0);
                histo[i][1968] = new TH1D(c(n, i, "_ZEtall_Nj5Nb1_OS"),              c(t, i, ": ZEtall Nj5Nb1 OS"),                          40, -4.0, 4.0);
                histo[i][1969] = new TH1D(c(n, i, "_ZEtall_Nj5Nb2_OS"),              c(t, i, ": ZEtall Nj5Nb2 OS"),                          40, -4.0, 4.0);
                // Nj>=6
                histo[i][1970] = new TH1D(c(n, i, "_ZEtall_Nj6Pre_OS"),              c(t, i, ": ZEtall Nj6Pre OS"),                          40, -4.0, 4.0);
                histo[i][1971] = new TH1D(c(n, i, "_ZEtall_Nj6Nb0_OS"),              c(t, i, ": ZEtall Nj6Nb0 OS"),                          40, -4.0, 4.0);
                histo[i][1972] = new TH1D(c(n, i, "_ZEtall_Nj6Nb1_OS"),              c(t, i, ": ZEtall Nj6Nb1 OS"),                          40, -4.0, 4.0);
                histo[i][1973] = new TH1D(c(n, i, "_ZEtall_Nj6Nb2_OS"),              c(t, i, ": ZEtall Nj6Nb2 OS"),                          40, -4.0, 4.0);

                // Nj>=2 Nb0>=0 Pt (ttbar+jj=ALL jets+lep+miss) ---------------
                histo[i][1980] = new TH1D(c(n, i, "_AllPTZll_NjGe2NbGe0_OS"),          c(t, i, ": AllPTZll Nj2GeNbGe0 OS"),                      bPt,    lPt, hPt    );
                histo[i][1981] = new TH1D(c(n, i, "_AllPTZll_NjGe2Nb0_OS"),            c(t, i, ": AllPTZll Nj2GeNb0 OS"),                        bPt,    lPt, hPt    );
                histo[i][1982] = new TH1D(c(n, i, "_AllPTZll_NjGe2Nb1_OS"),            c(t, i, ": AllPTZll Nj2GeNb1 OS"),                        bPt,    lPt, hPt    );
                histo[i][1983] = new TH1D(c(n, i, "_AllPTZll_NjGe2Nb2_OS"),            c(t, i, ": AllPTZll Nj2GeNb2 OS"),                        bPt,    lPt, hPt    );
                // Nj=2 
                histo[i][1984] = new TH1D(c(n, i, "_AllPTZll_Nj2Pre_OS"),              c(t, i, ": AllPTZll Nj2Pre OS"),                          bPt,    lPt, hPt    );
                histo[i][1985] = new TH1D(c(n, i, "_AllPTZll_Nj2Nb0_OS"),              c(t, i, ": AllPTZll Nj2Nb0 OS"),                          bPt,    lPt, hPt    );
                histo[i][1986] = new TH1D(c(n, i, "_AllPTZll_Nj2Nb1_OS"),              c(t, i, ": AllPTZll Nj2Nb1 OS"),                          bPt,    lPt, hPt    );
                histo[i][1987] = new TH1D(c(n, i, "_AllPTZll_Nj2Nb2_OS"),              c(t, i, ": AllPTZll Nj2Nb2 OS"),                          bPt,    lPt, hPt    );
                // Nj=3
                histo[i][1988] = new TH1D(c(n, i, "_AllPTZll_Nj3Pre_OS"),              c(t, i, ": AllPTZll Nj3Pre OS"),                          bPt,    lPt, hPt    );
                histo[i][1989] = new TH1D(c(n, i, "_AllPTZll_Nj3Nb0_OS"),              c(t, i, ": AllPTZll Nj3Nb0 OS"),                          bPt,    lPt, hPt    );
                histo[i][1990] = new TH1D(c(n, i, "_AllPTZll_Nj3Nb1_OS"),              c(t, i, ": AllPTZll Nj3Nb1 OS"),                          bPt,    lPt, hPt    );
                histo[i][1991] = new TH1D(c(n, i, "_AllPTZll_Nj3Nb2_OS"),              c(t, i, ": AllPTZll Nj3Nb2 OS"),                          bPt,    lPt, hPt    );
                // Nj=4
                histo[i][1992] = new TH1D(c(n, i, "_AllPTZll_Nj4Pre_OS"),              c(t, i, ": AllPTZll Nj4Pre OS"),                          bPt,    lPt, hPt    );
                histo[i][1993] = new TH1D(c(n, i, "_AllPTZll_Nj4Nb0_OS"),              c(t, i, ": AllPTZll Nj4Nb0 OS"),                          bPt,    lPt, hPt    );
                histo[i][1994] = new TH1D(c(n, i, "_AllPTZll_Nj4Nb1_OS"),              c(t, i, ": AllPTZll Nj4Nb1 OS"),                          bPt,    lPt, hPt    );
                histo[i][1995] = new TH1D(c(n, i, "_AllPTZll_Nj4Nb2_OS"),              c(t, i, ": AllPTZll Nj4Nb2 OS"),                          bPt,    lPt, hPt    );
                // Nj=5
                histo[i][1996] = new TH1D(c(n, i, "_AllPTZll_Nj5Pre_OS"),              c(t, i, ": AllPTZll Nj5Pre OS"),                          bPt,    lPt, hPt    );
                histo[i][1997] = new TH1D(c(n, i, "_AllPTZll_Nj5Nb0_OS"),              c(t, i, ": AllPTZll Nj5Nb0 OS"),                          bPt,    lPt, hPt    );
                histo[i][1998] = new TH1D(c(n, i, "_AllPTZll_Nj5Nb1_OS"),              c(t, i, ": AllPTZll Nj5Nb1 OS"),                          bPt,    lPt, hPt    );
                histo[i][1999] = new TH1D(c(n, i, "_AllPTZll_Nj5Nb2_OS"),              c(t, i, ": AllPTZll Nj5Nb2 OS"),                          bPt,    lPt, hPt    );
                // Nj>=6
                histo[i][2000] = new TH1D(c(n, i, "_AllPTZll_Nj6Pre_OS"),              c(t, i, ": AllPTZll Nj6Pre OS"),                          bPt,    lPt, hPt    );
                histo[i][2001] = new TH1D(c(n, i, "_AllPTZll_Nj6Nb0_OS"),              c(t, i, ": AllPTZll Nj6Nb0 OS"),                          bPt,    lPt, hPt    );
                histo[i][2002] = new TH1D(c(n, i, "_AllPTZll_Nj6Nb1_OS"),              c(t, i, ": AllPTZll Nj6Nb1 OS"),                          bPt,    lPt, hPt    );
                histo[i][2003] = new TH1D(c(n, i, "_AllPTZll_Nj6Nb2_OS"),              c(t, i, ": AllPTZll Nj6Nb2 OS"),                          bPt,    lPt, hPt    );

                // Nj>=2 Nb0>=0 PHI (l+l-) ------------------------------------
                histo[i][2010] = new TH1D(c(n, i, "_ZPhill_NjGe2NbGe0_OS"),          c(t, i, ": ZPhill Nj2GeNbGe0 OS"),                     40, -4.0, 4.0);
                histo[i][2011] = new TH1D(c(n, i, "_ZPhill_NjGe2Nb0_OS"),            c(t, i, ": ZPhill Nj2GeNb0 OS"),                       40, -4.0, 4.0);
                histo[i][2012] = new TH1D(c(n, i, "_ZPhill_NjGe2Nb1_OS"),            c(t, i, ": ZPhill Nj2GeNb1 OS"),                       40, -4.0, 4.0);
                histo[i][2013] = new TH1D(c(n, i, "_ZPhill_NjGe2Nb2_OS"),            c(t, i, ": ZPhill Nj2GeNb2 OS"),                       40, -4.0, 4.0);
                // Nj=2
                histo[i][2014] = new TH1D(c(n, i, "_ZPhill_Nj2Pre_OS"),              c(t, i, ": ZPhill Nj2Pre OS"),                          40, -4.0, 4.0);
                histo[i][2015] = new TH1D(c(n, i, "_ZPhill_Nj2Nb0_OS"),              c(t, i, ": ZPhill Nj2Nb0 OS"),                          40, -4.0, 4.0);
                histo[i][2016] = new TH1D(c(n, i, "_ZPhill_Nj2Nb1_OS"),              c(t, i, ": ZPhill Nj2Nb1 OS"),                          40, -4.0, 4.0);
                histo[i][2017] = new TH1D(c(n, i, "_ZPhill_Nj2Nb2_OS"),              c(t, i, ": ZPhill Nj2Nb2 OS"),                          40, -4.0, 4.0);
                // Nj=3
                histo[i][2018] = new TH1D(c(n, i, "_ZPhill_Nj3Pre_OS"),              c(t, i, ": ZPhill Nj3Pre OS"),                          40, -4.0, 4.0);
                histo[i][2019] = new TH1D(c(n, i, "_ZPhill_Nj3Nb0_OS"),              c(t, i, ": ZPhill Nj3Nb0 OS"),                          40, -4.0, 4.0);
                histo[i][2020] = new TH1D(c(n, i, "_ZPhill_Nj3Nb1_OS"),              c(t, i, ": ZPhill Nj3Nb1 OS"),                          40, -4.0, 4.0);
                histo[i][2021] = new TH1D(c(n, i, "_ZPhill_Nj3Nb2_OS"),              c(t, i, ": ZPhill Nj3Nb2 OS"),                          40, -4.0, 4.0);
                // Nj=4
                histo[i][2022] = new TH1D(c(n, i, "_ZPhill_Nj4Pre_OS"),              c(t, i, ": ZPhill Nj4Pre OS"),                          40, -4.0, 4.0);
                histo[i][2023] = new TH1D(c(n, i, "_ZPhill_Nj4Nb0_OS"),              c(t, i, ": ZPhill Nj4Nb0 OS"),                          40, -4.0, 4.0);
                histo[i][2024] = new TH1D(c(n, i, "_ZPhill_Nj4Nb1_OS"),              c(t, i, ": ZPhill Nj4Nb1 OS"),                          40, -4.0, 4.0);
                histo[i][2025] = new TH1D(c(n, i, "_ZPhill_Nj4Nb2_OS"),              c(t, i, ": ZPhill Nj4Nb2 OS"),                          40, -4.0, 4.0);
                // Nj=5
                histo[i][2026] = new TH1D(c(n, i, "_ZPhill_Nj5Pre_OS"),              c(t, i, ": ZPhill Nj5Pre OS"),                          40, -4.0, 4.0);
                histo[i][2027] = new TH1D(c(n, i, "_ZPhill_Nj5Nb0_OS"),              c(t, i, ": ZPhill Nj5Nb0 OS"),                          40, -4.0, 4.0);
                histo[i][2028] = new TH1D(c(n, i, "_ZPhill_Nj5Nb1_OS"),              c(t, i, ": ZPhill Nj5Nb1 OS"),                          40, -4.0, 4.0);
                histo[i][2029] = new TH1D(c(n, i, "_ZPhill_Nj5Nb2_OS"),              c(t, i, ": ZPhill Nj5Nb2 OS"),                          40, -4.0, 4.0);
                // Nj>=6
                histo[i][2030] = new TH1D(c(n, i, "_ZPhill_Nj6Pre_OS"),              c(t, i, ": ZPhill Nj6Pre OS"),                          40, -4.0, 4.0);
                histo[i][2031] = new TH1D(c(n, i, "_ZPhill_Nj6Nb0_OS"),              c(t, i, ": ZPhill Nj6Nb0 OS"),                          40, -4.0, 4.0);
                histo[i][2032] = new TH1D(c(n, i, "_ZPhill_Nj6Nb1_OS"),              c(t, i, ": ZPhill Nj6Nb1 OS"),                          40, -4.0, 4.0);
                histo[i][2033] = new TH1D(c(n, i, "_ZPhill_Nj6Nb2_OS"),              c(t, i, ": ZPhill Nj6Nb2 OS"),                          40, -4.0, 4.0);
		...
		// ================= SS Distributions =========================
                ...
                // Nj>=2 Nb0>=0 Counters --------------------------------------
                histo[i][400+1830] = new TH1D(c(n, i, "_ZlljetsDD_NjGe2NbGe0_SS"),      c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR NjGe2NbGe0 SS"),  10, -0.5,  9.5  );
                histo[i][400+1831] = new TH1D(c(n, i, "_ZlljetsDD_NjGe2Nb0_SS"),        c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR NjGe2Nb0 SS"),    10, -0.5,  9.5  );
                histo[i][400+1832] = new TH1D(c(n, i, "_ZlljetsDD_NjGe2Nb1_SS"),        c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR NjGe2Nb1 SS"),    10, -0.5,  9.5  );
                histo[i][400+1833] = new TH1D(c(n, i, "_ZlljetsDD_NjGe2Nb2_SS"),        c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR NjGe2Nb2 SS"),    10, -0.5,  9.5  );
                // Nj=2 Counters 
                histo[i][400+1834] = new TH1D(c(n, i, "_ZlljetsDD_Nj2Pre_SS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj2Pre SS"),     10, -0.5,  9.5  );
                histo[i][400+1835] = new TH1D(c(n, i, "_ZlljetsDD_Nj2Nb0_SS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj2Nb0 SS"),     10, -0.5,  9.5  );
                histo[i][400+1836] = new TH1D(c(n, i, "_ZlljetsDD_Nj2Nb1_SS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj2Nb1 SS"),     10, -0.5,  9.5  );
                histo[i][400+1837] = new TH1D(c(n, i, "_ZlljetsDD_Nj2Nb2_SS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj2Nb2 SS"),     10, -0.5,  9.5  );
                // Nj=3 Counters
                histo[i][400+1838] = new TH1D(c(n, i, "_ZlljetsDD_Nj3Pre_SS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj3Pre SS"),     10, -0.5,  9.5  );
                histo[i][400+1839] = new TH1D(c(n, i, "_ZlljetsDD_Nj3Nb0_SS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj3Nb0 SS"),     10, -0.5,  9.5  );
                histo[i][400+1840] = new TH1D(c(n, i, "_ZlljetsDD_Nj3Nb1_SS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj3Nb1 SS"),     10, -0.5,  9.5  );
                histo[i][400+1841] = new TH1D(c(n, i, "_ZlljetsDD_Nj3Nb2_SS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj3Nb2 SS"),     10, -0.5,  9.5  );
                // Nj=4 Counters
                histo[i][400+1842] = new TH1D(c(n, i, "_ZlljetsDD_Nj4Pre_SS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj4Pre SS"),     10, -0.5,  9.5  );
                histo[i][400+1843] = new TH1D(c(n, i, "_ZlljetsDD_Nj4Nb0_SS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj4Nb0 SS"),     10, -0.5,  9.5  );
                histo[i][400+1844] = new TH1D(c(n, i, "_ZlljetsDD_Nj4Nb1_SS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj4Nb1 SS"),     10, -0.5,  9.5  );
                histo[i][400+1845] = new TH1D(c(n, i, "_ZlljetsDD_Nj4Nb2_SS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj4Nb2 SS"),     10, -0.5,  9.5  );
                // Nj=5 Counters
                histo[i][400+1846] = new TH1D(c(n, i, "_ZlljetsDD_Nj5Pre_SS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj5Pre SS"),     10, -0.5,  9.5  );
                histo[i][400+1847] = new TH1D(c(n, i, "_ZlljetsDD_Nj5Nb0_SS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj5Nb0 SS"),     10, -0.5,  9.5  );
                histo[i][400+1848] = new TH1D(c(n, i, "_ZlljetsDD_Nj5Nb1_SS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj5Nb1 SS"),     10, -0.5,  9.5  );
                histo[i][400+1849] = new TH1D(c(n, i, "_ZlljetsDD_Nj5Nb2_SS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj5Nb2 SS"),     10, -0.5,  9.5  );
                // Nj>=6 Counters
                histo[i][400+1850] = new TH1D(c(n, i, "_ZlljetsDD_Nj6Pre_SS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj6Pre SS"),     10, -0.5,  9.5  );
                histo[i][400+1851] = new TH1D(c(n, i, "_ZlljetsDD_Nj6Nb0_SS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj6Nb0 SS"),     10, -0.5,  9.5  );
                histo[i][400+1852] = new TH1D(c(n, i, "_ZlljetsDD_Nj6Nb1_SS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj6Nb1 SS"),     10, -0.5,  9.5  );
                histo[i][400+1853] = new TH1D(c(n, i, "_ZlljetsDD_Nj6Nb2_SS"),          c(t, i, ": ZlljetsDD 1=SR, 2=CR, 3=SR Nj6Nb2 SS"),     10, -0.5,  9.5  );

                // Nj>=2 Nb0>=0 Mass(ll) --------------------------------------
                histo[i][400+1860] = new TH1D(c(n, i, "_ZMll_NjGe2NbGe0_SS"),          c(t, i, ": ZMll Nj2GeNbGe0 SS"),                      bM,    lM, hM    );
                histo[i][400+1861] = new TH1D(c(n, i, "_ZMll_NjGe2Nb0_SS"),            c(t, i, ": ZMll Nj2GeNb0 SS"),                        bM,    lM, hM    );
                histo[i][400+1862] = new TH1D(c(n, i, "_ZMll_NjGe2Nb1_SS"),            c(t, i, ": ZMll Nj2GeNb1 SS"),                        bM,    lM, hM    );
                histo[i][400+1863] = new TH1D(c(n, i, "_ZMll_NjGe2Nb2_SS"),            c(t, i, ": ZMll Nj2GeNb2 SS"),                        bM,    lM, hM    );
                // Nj=2 
                histo[i][400+1864] = new TH1D(c(n, i, "_ZMll_Nj2Pre_SS"),              c(t, i, ": ZMll Nj2Pre SS"),                          bM,    lM, hM    );
                histo[i][400+1865] = new TH1D(c(n, i, "_ZMll_Nj2Nb0_SS"),              c(t, i, ": ZMll Nj2Nb0 SS"),                          bM,    lM, hM    );
                histo[i][400+1866] = new TH1D(c(n, i, "_ZMll_Nj2Nb1_SS"),              c(t, i, ": ZMll Nj2Nb1 SS"),                          bM,    lM, hM    );
                histo[i][400+1867] = new TH1D(c(n, i, "_ZMll_Nj2Nb2_SS"),              c(t, i, ": ZMll Nj2Nb2 SS"),                          bM,    lM, hM    );
                // Nj=3
                histo[i][400+1868] = new TH1D(c(n, i, "_ZMll_Nj3Pre_SS"),              c(t, i, ": ZMll Nj3Pre SS"),                          bM,    lM, hM    );
                histo[i][400+1869] = new TH1D(c(n, i, "_ZMll_Nj3Nb0_SS"),              c(t, i, ": ZMll Nj3Nb0 SS"),                          bM,    lM, hM    );
                histo[i][400+1870] = new TH1D(c(n, i, "_ZMll_Nj3Nb1_SS"),              c(t, i, ": ZMll Nj3Nb1 SS"),                          bM,    lM, hM    );
                histo[i][400+1871] = new TH1D(c(n, i, "_ZMll_Nj3Nb2_SS"),              c(t, i, ": ZMll Nj3Nb2 SS"),                          bM,    lM, hM    );
                // Nj=4
                histo[i][400+1872] = new TH1D(c(n, i, "_ZMll_Nj4Pre_SS"),              c(t, i, ": ZMll Nj4Pre SS"),                          bM,    lM, hM    );
                histo[i][400+1873] = new TH1D(c(n, i, "_ZMll_Nj4Nb0_SS"),              c(t, i, ": ZMll Nj4Nb0 SS"),                          bM,    lM, hM    );
                histo[i][400+1874] = new TH1D(c(n, i, "_ZMll_Nj4Nb1_SS"),              c(t, i, ": ZMll Nj4Nb1 SS"),                          bM,    lM, hM    );
                histo[i][400+1875] = new TH1D(c(n, i, "_ZMll_Nj4Nb2_SS"),              c(t, i, ": ZMll Nj4Nb2 SS"),                          bM,    lM, hM    );
                // Nj=5
                histo[i][400+1876] = new TH1D(c(n, i, "_ZMll_Nj5Pre_SS"),              c(t, i, ": ZMll Nj5Pre SS"),                          bM,    lM, hM    );
                histo[i][400+1877] = new TH1D(c(n, i, "_ZMll_Nj5Nb0_SS"),              c(t, i, ": ZMll Nj5Nb0 SS"),                          bM,    lM, hM    );
                histo[i][400+1878] = new TH1D(c(n, i, "_ZMll_Nj5Nb1_SS"),              c(t, i, ": ZMll Nj5Nb1 SS"),                          bM,    lM, hM    );
                histo[i][400+1879] = new TH1D(c(n, i, "_ZMll_Nj5Nb2_SS"),              c(t, i, ": ZMll Nj5Nb2 SS"),                          bM,    lM, hM    );
                // Nj>=6
                histo[i][400+1880] = new TH1D(c(n, i, "_ZMll_Nj6Pre_SS"),              c(t, i, ": ZMll Nj6Pre SS"),                          bM,    lM, hM    );
                histo[i][400+1881] = new TH1D(c(n, i, "_ZMll_Nj6Nb0_SS"),              c(t, i, ": ZMll Nj6Nb0 SS"),                          bM,    lM, hM    );
                histo[i][400+1882] = new TH1D(c(n, i, "_ZMll_Nj6Nb1_SS"),              c(t, i, ": ZMll Nj6Nb1 SS"),                          bM,    lM, hM    );
                histo[i][400+1883] = new TH1D(c(n, i, "_ZMll_Nj6Nb2_SS"),              c(t, i, ": ZMll Nj6Nb2 SS"),                          bM,    lM, hM    );

                // Nj>=2 Nb0>=0 Pt (ttbar) ------------------------------------
                histo[i][400+1890] = new TH1D(c(n, i, "_PTZll_NjGe2NbGe0_SS"),          c(t, i, ": PTZll Nj2GeNbGe0 SS"),                      bPt,    lPt, hPt    );
                histo[i][400+1891] = new TH1D(c(n, i, "_PTZll_NjGe2Nb0_SS"),            c(t, i, ": PTZll Nj2GeNb0 SS"),                        bPt,    lPt, hPt    );
                histo[i][400+1892] = new TH1D(c(n, i, "_PTZll_NjGe2Nb1_SS"),            c(t, i, ": PTZll Nj2GeNb1 SS"),                        bPt,    lPt, hPt    );
                histo[i][400+1893] = new TH1D(c(n, i, "_PTZll_NjGe2Nb2_SS"),            c(t, i, ": PTZll Nj2GeNb2 SS"),                        bPt,    lPt, hPt    );
                // Nj=2 
                histo[i][400+1894] = new TH1D(c(n, i, "_PTZll_Nj2Pre_SS"),              c(t, i, ": PTZll Nj2Pre SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1895] = new TH1D(c(n, i, "_PTZll_Nj2Nb0_SS"),              c(t, i, ": PTZll Nj2Nb0 SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1896] = new TH1D(c(n, i, "_PTZll_Nj2Nb1_SS"),              c(t, i, ": PTZll Nj2Nb1 SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1897] = new TH1D(c(n, i, "_PTZll_Nj2Nb2_SS"),              c(t, i, ": PTZll Nj2Nb2 SS"),                          bPt,    lPt, hPt    );
                // Nj=3
                histo[i][400+1898] = new TH1D(c(n, i, "_PTZll_Nj3Pre_SS"),              c(t, i, ": PTZll Nj3Pre SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1899] = new TH1D(c(n, i, "_PTZll_Nj3Nb0_SS"),              c(t, i, ": PTZll Nj3Nb0 SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1900] = new TH1D(c(n, i, "_PTZll_Nj3Nb1_SS"),              c(t, i, ": PTZll Nj3Nb1 SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1901] = new TH1D(c(n, i, "_PTZll_Nj3Nb2_SS"),              c(t, i, ": PTZll Nj3Nb2 SS"),                          bPt,    lPt, hPt    );
                // Nj=4
                histo[i][400+1902] = new TH1D(c(n, i, "_PTZll_Nj4Pre_SS"),              c(t, i, ": PTZll Nj4Pre SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1903] = new TH1D(c(n, i, "_PTZll_Nj4Nb0_SS"),              c(t, i, ": PTZll Nj4Nb0 SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1904] = new TH1D(c(n, i, "_PTZll_Nj4Nb1_SS"),              c(t, i, ": PTZll Nj4Nb1 SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1905] = new TH1D(c(n, i, "_PTZll_Nj4Nb2_SS"),              c(t, i, ": PTZll Nj4Nb2 SS"),                          bPt,    lPt, hPt    );
                // Nj=5
                histo[i][400+1906] = new TH1D(c(n, i, "_PTZll_Nj5Pre_SS"),              c(t, i, ": PTZll Nj5Pre SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1907] = new TH1D(c(n, i, "_PTZll_Nj5Nb0_SS"),              c(t, i, ": PTZll Nj5Nb0 SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1908] = new TH1D(c(n, i, "_PTZll_Nj5Nb1_SS"),              c(t, i, ": PTZll Nj5Nb1 SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1909] = new TH1D(c(n, i, "_PTZll_Nj5Nb2_SS"),              c(t, i, ": PTZll Nj5Nb2 SS"),                          bPt,    lPt, hPt    );
                // Nj>=6
                histo[i][400+1910] = new TH1D(c(n, i, "_PTZll_Nj6Pre_SS"),              c(t, i, ": PTZll Nj6Pre SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1911] = new TH1D(c(n, i, "_PTZll_Nj6Nb0_SS"),              c(t, i, ": PTZll Nj6Nb0 SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1912] = new TH1D(c(n, i, "_PTZll_Nj6Nb1_SS"),              c(t, i, ": PTZll Nj6Nb1 SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1913] = new TH1D(c(n, i, "_PTZll_Nj6Nb2_SS"),              c(t, i, ": PTZll Nj6Nb2 SS"),                          bPt,    lPt, hPt    );
                ...
                // Nj>=2 Nb0>=0 ETA (l+l-) ------------------------------------
                histo[i][400+1950] = new TH1D(c(n, i, "_ZEtall_NjGe2NbGe0_SS"),          c(t, i, ": ZEtall Nj2GeNbGe0 SS"),                     40, -4.0, 4.0);
                histo[i][400+1951] = new TH1D(c(n, i, "_ZEtall_NjGe2Nb0_SS"),            c(t, i, ": ZEtall Nj2GeNb0 SS"),                       40, -4.0, 4.0);
                histo[i][400+1952] = new TH1D(c(n, i, "_ZEtall_NjGe2Nb1_SS"),            c(t, i, ": ZEtall Nj2GeNb1 SS"),                       40, -4.0, 4.0);
                histo[i][400+1953] = new TH1D(c(n, i, "_ZEtall_NjGe2Nb2_SS"),            c(t, i, ": ZEtall Nj2GeNb2 SS"),                       40, -4.0, 4.0);
                // Nj=2 
                histo[i][400+1954] = new TH1D(c(n, i, "_ZEtall_Nj2Pre_SS"),              c(t, i, ": ZEtall Nj2Pre SS"),                          40, -4.0, 4.0);
                histo[i][400+1955] = new TH1D(c(n, i, "_ZEtall_Nj2Nb0_SS"),              c(t, i, ": ZEtall Nj2Nb0 SS"),                          40, -4.0, 4.0);
                histo[i][400+1956] = new TH1D(c(n, i, "_ZEtall_Nj2Nb1_SS"),              c(t, i, ": ZEtall Nj2Nb1 SS"),                          40, -4.0, 4.0);
                histo[i][400+1957] = new TH1D(c(n, i, "_ZEtall_Nj2Nb2_SS"),              c(t, i, ": ZEtall Nj2Nb2 SS"),                          40, -4.0, 4.0);
                // Nj=3
                histo[i][400+1958] = new TH1D(c(n, i, "_ZEtall_Nj3Pre_SS"),              c(t, i, ": ZEtall Nj3Pre SS"),                          40, -4.0, 4.0);
                histo[i][400+1959] = new TH1D(c(n, i, "_ZEtall_Nj3Nb0_SS"),              c(t, i, ": ZEtall Nj3Nb0 SS"),                          40, -4.0, 4.0);
                histo[i][400+1960] = new TH1D(c(n, i, "_ZEtall_Nj3Nb1_SS"),              c(t, i, ": ZEtall Nj3Nb1 SS"),                          40, -4.0, 4.0);
                histo[i][400+1961] = new TH1D(c(n, i, "_ZEtall_Nj3Nb2_SS"),              c(t, i, ": ZEtall Nj3Nb2 SS"),                          40, -4.0, 4.0);
                // Nj=4
                histo[i][400+1962] = new TH1D(c(n, i, "_ZEtall_Nj4Pre_SS"),              c(t, i, ": ZEtall Nj4Pre SS"),                          40, -4.0, 4.0);
                histo[i][400+1963] = new TH1D(c(n, i, "_ZEtall_Nj4Nb0_SS"),              c(t, i, ": ZEtall Nj4Nb0 SS"),                          40, -4.0, 4.0);
                histo[i][400+1964] = new TH1D(c(n, i, "_ZEtall_Nj4Nb1_SS"),              c(t, i, ": ZEtall Nj4Nb1 SS"),                          40, -4.0, 4.0);
                histo[i][400+1965] = new TH1D(c(n, i, "_ZEtall_Nj4Nb2_SS"),              c(t, i, ": ZEtall Nj4Nb2 SS"),                          40, -4.0, 4.0);
                // Nj=5
                histo[i][400+1966] = new TH1D(c(n, i, "_ZEtall_Nj5Pre_SS"),              c(t, i, ": ZEtall Nj5Pre SS"),                          40, -4.0, 4.0);
                histo[i][400+1967] = new TH1D(c(n, i, "_ZEtall_Nj5Nb0_SS"),              c(t, i, ": ZEtall Nj5Nb0 SS"),                          40, -4.0, 4.0);
                histo[i][400+1968] = new TH1D(c(n, i, "_ZEtall_Nj5Nb1_SS"),              c(t, i, ": ZEtall Nj5Nb1 SS"),                          40, -4.0, 4.0);
                histo[i][400+1969] = new TH1D(c(n, i, "_ZEtall_Nj5Nb2_SS"),              c(t, i, ": ZEtall Nj5Nb2 SS"),                          40, -4.0, 4.0);
                // Nj>=6
                histo[i][400+1970] = new TH1D(c(n, i, "_ZEtall_Nj6Pre_SS"),              c(t, i, ": ZEtall Nj6Pre SS"),                          40, -4.0, 4.0);
                histo[i][400+1971] = new TH1D(c(n, i, "_ZEtall_Nj6Nb0_SS"),              c(t, i, ": ZEtall Nj6Nb0 SS"),                          40, -4.0, 4.0);
                histo[i][400+1972] = new TH1D(c(n, i, "_ZEtall_Nj6Nb1_SS"),              c(t, i, ": ZEtall Nj6Nb1 SS"),                          40, -4.0, 4.0);
                histo[i][400+1973] = new TH1D(c(n, i, "_ZEtall_Nj6Nb2_SS"),              c(t, i, ": ZEtall Nj6Nb2 SS"),                          40, -4.0, 4.0);

                // Nj>=2 Nb0>=0 Pt (ttbar+jj=ALL jets+lep+miss) ---------------
                histo[i][400+1980] = new TH1D(c(n, i, "_AllPTZll_NjGe2NbGe0_SS"),          c(t, i, ": AllPTZll Nj2GeNbGe0 SS"),                      bPt,    lPt, hPt    );
                histo[i][400+1981] = new TH1D(c(n, i, "_AllPTZll_NjGe2Nb0_SS"),            c(t, i, ": AllPTZll Nj2GeNb0 SS"),                        bPt,    lPt, hPt    );
                histo[i][400+1982] = new TH1D(c(n, i, "_AllPTZll_NjGe2Nb1_SS"),            c(t, i, ": AllPTZll Nj2GeNb1 SS"),                        bPt,    lPt, hPt    );
                histo[i][400+1983] = new TH1D(c(n, i, "_AllPTZll_NjGe2Nb2_SS"),            c(t, i, ": AllPTZll Nj2GeNb2 SS"),                        bPt,    lPt, hPt    );
                // Nj=2 
                histo[i][400+1984] = new TH1D(c(n, i, "_AllPTZll_Nj2Pre_SS"),              c(t, i, ": AllPTZll Nj2Pre SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1985] = new TH1D(c(n, i, "_AllPTZll_Nj2Nb0_SS"),              c(t, i, ": AllPTZll Nj2Nb0 SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1986] = new TH1D(c(n, i, "_AllPTZll_Nj2Nb1_SS"),              c(t, i, ": AllPTZll Nj2Nb1 SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1987] = new TH1D(c(n, i, "_AllPTZll_Nj2Nb2_SS"),              c(t, i, ": AllPTZll Nj2Nb2 SS"),                          bPt,    lPt, hPt    );
                // Nj=3
                histo[i][400+1988] = new TH1D(c(n, i, "_AllPTZll_Nj3Pre_SS"),              c(t, i, ": AllPTZll Nj3Pre SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1989] = new TH1D(c(n, i, "_AllPTZll_Nj3Nb0_SS"),              c(t, i, ": AllPTZll Nj3Nb0 SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1990] = new TH1D(c(n, i, "_AllPTZll_Nj3Nb1_SS"),              c(t, i, ": AllPTZll Nj3Nb1 SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1991] = new TH1D(c(n, i, "_AllPTZll_Nj3Nb2_SS"),              c(t, i, ": AllPTZll Nj3Nb2 SS"),                          bPt,    lPt, hPt    );
                // Nj=4
                histo[i][400+1992] = new TH1D(c(n, i, "_AllPTZll_Nj4Pre_SS"),              c(t, i, ": AllPTZll Nj4Pre SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1993] = new TH1D(c(n, i, "_AllPTZll_Nj4Nb0_SS"),              c(t, i, ": AllPTZll Nj4Nb0 SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1994] = new TH1D(c(n, i, "_AllPTZll_Nj4Nb1_SS"),              c(t, i, ": AllPTZll Nj4Nb1 SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1995] = new TH1D(c(n, i, "_AllPTZll_Nj4Nb2_SS"),              c(t, i, ": AllPTZll Nj4Nb2 SS"),                          bPt,    lPt, hPt    );
                // Nj=5
                histo[i][400+1996] = new TH1D(c(n, i, "_AllPTZll_Nj5Pre_SS"),              c(t, i, ": AllPTZll Nj5Pre SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1997] = new TH1D(c(n, i, "_AllPTZll_Nj5Nb0_SS"),              c(t, i, ": AllPTZll Nj5Nb0 SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1998] = new TH1D(c(n, i, "_AllPTZll_Nj5Nb1_SS"),              c(t, i, ": AllPTZll Nj5Nb1 SS"),                          bPt,    lPt, hPt    );
                histo[i][400+1999] = new TH1D(c(n, i, "_AllPTZll_Nj5Nb2_SS"),              c(t, i, ": AllPTZll Nj5Nb2 SS"),                          bPt,    lPt, hPt    );
                // Nj>=6
                histo[i][400+2000] = new TH1D(c(n, i, "_AllPTZll_Nj6Pre_SS"),              c(t, i, ": AllPTZll Nj6Pre SS"),                          bPt,    lPt, hPt    );
                histo[i][400+2001] = new TH1D(c(n, i, "_AllPTZll_Nj6Nb0_SS"),              c(t, i, ": AllPTZll Nj6Nb0 SS"),                          bPt,    lPt, hPt    );
                histo[i][400+2002] = new TH1D(c(n, i, "_AllPTZll_Nj6Nb1_SS"),              c(t, i, ": AllPTZll Nj6Nb1 SS"),                          bPt,    lPt, hPt    );
                histo[i][400+2003] = new TH1D(c(n, i, "_AllPTZll_Nj6Nb2_SS"),              c(t, i, ": AllPTZll Nj6Nb2 SS"),                          bPt,    lPt, hPt    );

                // Nj>=2 Nb0>=0 PHI (l+l-) ------------------------------------
                histo[i][400+2010] = new TH1D(c(n, i, "_ZPhill_NjGe2NbGe0_SS"),          c(t, i, ": ZPhill Nj2GeNbGe0 SS"),                     40, -4.0, 4.0);
                histo[i][400+2011] = new TH1D(c(n, i, "_ZPhill_NjGe2Nb0_SS"),            c(t, i, ": ZPhill Nj2GeNb0 SS"),                       40, -4.0, 4.0);
                histo[i][400+2012] = new TH1D(c(n, i, "_ZPhill_NjGe2Nb1_SS"),            c(t, i, ": ZPhill Nj2GeNb1 SS"),                       40, -4.0, 4.0);
                histo[i][400+2013] = new TH1D(c(n, i, "_ZPhill_NjGe2Nb2_SS"),            c(t, i, ": ZPhill Nj2GeNb2 SS"),                       40, -4.0, 4.0);
                // Nj=2
                histo[i][400+2014] = new TH1D(c(n, i, "_ZPhill_Nj2Pre_SS"),              c(t, i, ": ZPhill Nj2Pre SS"),                          40, -4.0, 4.0);
                histo[i][400+2015] = new TH1D(c(n, i, "_ZPhill_Nj2Nb0_SS"),              c(t, i, ": ZPhill Nj2Nb0 SS"),                          40, -4.0, 4.0);
                histo[i][400+2016] = new TH1D(c(n, i, "_ZPhill_Nj2Nb1_SS"),              c(t, i, ": ZPhill Nj2Nb1 SS"),                          40, -4.0, 4.0);
                histo[i][400+2017] = new TH1D(c(n, i, "_ZPhill_Nj2Nb2_SS"),              c(t, i, ": ZPhill Nj2Nb2 SS"),                          40, -4.0, 4.0);
                // Nj=3
                histo[i][400+2018] = new TH1D(c(n, i, "_ZPhill_Nj3Pre_SS"),              c(t, i, ": ZPhill Nj3Pre SS"),                          40, -4.0, 4.0);
                histo[i][400+2019] = new TH1D(c(n, i, "_ZPhill_Nj3Nb0_SS"),              c(t, i, ": ZPhill Nj3Nb0 SS"),                          40, -4.0, 4.0);
                histo[i][400+2020] = new TH1D(c(n, i, "_ZPhill_Nj3Nb1_SS"),              c(t, i, ": ZPhill Nj3Nb1 SS"),                          40, -4.0, 4.0);
                histo[i][400+2021] = new TH1D(c(n, i, "_ZPhill_Nj3Nb2_SS"),              c(t, i, ": ZPhill Nj3Nb2 SS"),                          40, -4.0, 4.0);
                // Nj=4
                histo[i][400+2022] = new TH1D(c(n, i, "_ZPhill_Nj4Pre_SS"),              c(t, i, ": ZPhill Nj4Pre SS"),                          40, -4.0, 4.0);
                histo[i][400+2023] = new TH1D(c(n, i, "_ZPhill_Nj4Nb0_SS"),              c(t, i, ": ZPhill Nj4Nb0 SS"),                          40, -4.0, 4.0);
                histo[i][400+2024] = new TH1D(c(n, i, "_ZPhill_Nj4Nb1_SS"),              c(t, i, ": ZPhill Nj4Nb1 SS"),                          40, -4.0, 4.0);
                histo[i][400+2025] = new TH1D(c(n, i, "_ZPhill_Nj4Nb2_SS"),              c(t, i, ": ZPhill Nj4Nb2 SS"),                          40, -4.0, 4.0);
                // Nj=5
                histo[i][400+2026] = new TH1D(c(n, i, "_ZPhill_Nj5Pre_SS"),              c(t, i, ": ZPhill Nj5Pre SS"),                          40, -4.0, 4.0);
                histo[i][400+2027] = new TH1D(c(n, i, "_ZPhill_Nj5Nb0_SS"),              c(t, i, ": ZPhill Nj5Nb0 SS"),                          40, -4.0, 4.0);
                histo[i][400+2028] = new TH1D(c(n, i, "_ZPhill_Nj5Nb1_SS"),              c(t, i, ": ZPhill Nj5Nb1 SS"),                          40, -4.0, 4.0);
                histo[i][400+2029] = new TH1D(c(n, i, "_ZPhill_Nj5Nb2_SS"),              c(t, i, ": ZPhill Nj5Nb2 SS"),                          40, -4.0, 4.0);
                // Nj>=6
                histo[i][400+2030] = new TH1D(c(n, i, "_ZPhill_Nj6Pre_SS"),              c(t, i, ": ZPhill Nj6Pre SS"),                          40, -4.0, 4.0);
                histo[i][400+2031] = new TH1D(c(n, i, "_ZPhill_Nj6Nb0_SS"),              c(t, i, ": ZPhill Nj6Nb0 SS"),                          40, -4.0, 4.0);
                histo[i][400+2032] = new TH1D(c(n, i, "_ZPhill_Nj6Nb1_SS"),              c(t, i, ": ZPhill Nj6Nb1 SS"),                          40, -4.0, 4.0);
                histo[i][400+2033] = new TH1D(c(n, i, "_ZPhill_Nj6Nb2_SS"),              c(t, i, ": ZPhill Nj6Nb2 SS"),                          40, -4.0, 4.0);
...
// #############################################################################
	...
	for(Int_t i = 0; i <= LastCut; ++i){
		...
		if ( myNjet >= 4 && myNBtag >= 4 ) 	histo[i][328]->Fill(   12., Weight);
                ...
                int nH    =  800;  // initialize as OS
                int nHtt  = 1800;  // initialize as OS for new ZDD

                // Check there are 2 leptons and at least 2 jets
                if(LeptonVec.size()>1 && MyGoodJetVec.size()>1 ){
                   ...
                   // define histogram id for all combinations
                   int nH_id ;
                   int nHpre ;
                   int nH_idGe2 ;
                   int nHpreGe2 ;
                   // define histogram id for all new ZDD combinations
                   int nHtt_id ;
                   int nHttpre ;
                   int nHtt_idGe2 ;
                   int nHttpreGe2 ;
                   ...
                   // ----------------------------------------
                   // define variables for new ZDD studies
                   // ----------------------------------------
                   ...
                   // ==============================================================================
                   // Njet >= 2 --------------------------------------------------------------------
                   if ( myNjet >= 2                 ) nHpreGe2 = nH ;      // Pretag
                   ...
                   // ==============================================================================
                   // Njet >= 2 --------------------------------------------------------------------
                   if ( myNjet >= 2                 ) nHttpreGe2 = nHtt ;      // Pretag
                   ...
                   // Njet = 2 ---------------------------------------------------------------------
                   if ( myNjet == 2                 ) nHttpre = nHtt + 4 ;  // Pretag
                   ...
                   // Njet = 3 ---------------------------------------------------------------------
                   if ( myNjet == 3                 ) nHttpre = nHtt + 8 ;  // Pretag
                   ...
                   // Njet = 4 ---------------------------------------------------------------------
                   if ( myNjet == 4                 ) nHttpre = nHtt +12 ;  // Pretag
                   ...
                   // Njet = 5 ---------------------------------------------------------------------
                   if ( myNjet == 5                 ) nHttpre = nHtt +16 ;  // Pretag
                   ...
                   // Njet>= 6 ---------------------------------------------------------------------
                   if ( myNjet >= 6                 ) nHttpre = nHtt +20 ;  // Pretag
                   ...
                   // ==============================================================================
                   // Fill Up histograms for ZDD studies
                   // ==============================================================================
                   ...
                   // Mll counter
                   if( fabs( xVar - 91.) < 12. ){  // inside the Z window (after 4*sigma cut)
			...
			// Fill phi distributions
                        ...
                        if( ( xVar - 91. ) <= -12.  ) { // inside the Z window (after 4*sigma cut)
				histo[i][nHpreGe2+30]->Fill(1.,Weight); 
				histo[i][nH_idGe2+30]->Fill(1.,Weight); 
				histo[i][nHpre+30]->Fill(1.,Weight); 
				histo[i][nH_id+30]->Fill(1.,Weight); 
                                if (yVar > 60.) {
                                        histo[i][nHpreGe2+30]->Fill(4.,Weight);
                                        histo[i][nH_idGe2+30]->Fill(4.,Weight);
                                        histo[i][nHpre+30]->Fill(4.,Weight);
                                        histo[i][nH_id+30]->Fill(4.,Weight);
				}
			}
                        if( ( xVar - 91. ) >= +12.  ) { // inside the Z window (after 4*sigma cut)
				histo[i][nHpreGe2+30]->Fill(3.,Weight); 
				histo[i][nH_idGe2+30]->Fill(3.,Weight); 
				histo[i][nHpre+30]->Fill(3.,Weight); 
				histo[i][nH_id+30]->Fill(3.,Weight); 
                                if (yVar > 60.) {
                                        histo[i][nHpreGe2+30]->Fill(6.,Weight);
                                        histo[i][nH_idGe2+30]->Fill(6.,Weight);
                                        histo[i][nHpre+30]->Fill(6.,Weight);
                                        histo[i][nH_id+30]->Fill(6.,Weight);
                                }
			}
                   }
		   ...
		   // Fill phi distributions
                   ...
                   // ==============================================================================
                   // Fill Up histograms for new ZDD studies
                   // ==============================================================================
                   ...
                   if( fabs( xVar - 91.) < 12. ){  // inside the Z window (after 4*sigma cut)	
                   	...
                   	// New ZDD counters, x=2. (pTmiss>0.), x=5. (pTmiss>60.GeV) (OS: 1830-1853, SS: add 400)
                   	...
                   	// Z + ALL jets system pT distribution                 
...
//                        ((TH2D*)histo[i][126])->Fill(Ht/GeV, MissPt/GeV, Weight);
                        ...
                        if( fabs(ll.M()/GeV-91.) < 8. ){
                                ...
                                if( (MissPt >  60.*GeV) && ( (ll.M()/GeV-91.)<= -8. ) ) histo[i][188]->Fill(0.,Weight);
                                if( (MissPt >  60.*GeV) && ( (ll.M()/GeV-91.)>= +8. ) ) histo[i][188]->Fill(0.,Weight);
                  	}
                        // ------------------------------------------------------------------------------------------------------

                        // Do OS distributions for Control Region
                        if ( MissPt/GeV > 30. && fabs(ll.M()/GeV-91.) < 8. )
                        {
        ...
        //                        ((TH2D*)histo[i][156])->Fill(Ht/GeV, MissPt/GeV, Weight);
                        ...
                        if ( MissPt/GeV > 60. && fabs(ll.M()/GeV-91.) >= 8. )
                        {
...
//                        ((TH2D*)histo[i][127])->Fill(Ht/GeV, MissPt/GeV, Weight);
                        ...
                        if( fabs(ll.M()/GeV-91.) < 8. ){
                                ...
                                if( (MissPt >  60.*GeV) && ( (ll.M()/GeV-91.)<= -8. ) ) histo[i][189]->Fill(0.,Weight);
                                if( (MissPt >  60.*GeV) && ( (ll.M()/GeV-91.)>= +8. ) ) histo[i][189]->Fill(0.,Weight);
                  	}
                        // ------------------------------------------------------------------------------------------------------

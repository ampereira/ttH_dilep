...
//        cout << "C7 runNumber=" << RunNumber << " eventNumber=" << EveNumber << endl;
	...
	if (   NbtagJet > 2 ) return; // New: events dont have more then 2 b-tags (avoid ttH)  
        LastCut++;	// LastCut=13
...
//        cout << "C8 b) runNumber=" << RunNumber << " eventNumber=" << EveNumber << endl;
	...
	//     a) Z Mass cut 1:    M(ll) > 15 GeV (ee,mm)
        //     b) Z Mass cut 2:|M(ll)-91|> 12 GeV (ee,mm) ===> 4 sigma cut
        //     b) Z Mass cut 2:|M(ll)-91|>  9 GeV (ee,mm) ===> 3 sigma cut
        //=============================================
...
//        cout << "C9 a) runNumber=" << RunNumber << " eventNumber=" << EveNumber << endl;
        ...
        //=============================================
        //=============================================
        // C9) b)  Z Mass cut: |M(ll)-91|>= 4*sigma  ==
        //         Z Mass cut: |M(ll)-91|>= 3*sigma  ==
        // Measured Z Masses and Widths in data:
	// m+m-:  Z mass  = 91.07 +- 0.01     
	//        Z width =  3.01 +- 0.01
	// e+e-:  Z mass  = 90.87 +- 0.02     
	//        Z width =  2.96 +- 0.01
        //=============================================
        //=============================================
        if( lepSample==21 ){ // ee sample
          //if( fabs(ll.M()/GeV-91.) <  9. ) return;  // 3*sigma cut
            if( fabs(ll.M()/GeV-91.) < 12. ) return;  // 4*sigma cut
        }
        if( lepSample==22 ){ // mumu sample
          //if( fabs(ll.M()/GeV-91.) <  9. ) return;  // 3*sigma cut
            if( fabs(ll.M()/GeV-91.) < 12. ) return;  // 4*sigma cut
